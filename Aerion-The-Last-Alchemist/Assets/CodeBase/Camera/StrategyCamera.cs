...
{
    [Header("Orbiting Input settings")] public string HorizontalOrbitingAxis = "Mouse X";
    ...
    [Header("Orbiting limits")] [Range(0, 90)]
    public float MinVerticalAngle = 10;

    [Range(0, 90)] public float MaxVerticalAngle = 80;


    [Header("Movement Input settings")] public MouseButton MoveMouseButton = MouseButton.RightMouseButton;
    ...
    [Header("Movement limits")] public bool ConstrainPosition;
    public Vector3 MinPosition;
    public Vector3 MaxPosition;


    [Header("Zooming Input settings")] public string InputAxisZoom = "Mouse ScrollWheel";
    public bool InvertZooming = false;

    [Header("Zooming speeds")] public float ZoomSensitivity = 1f;
    ...
    [Header("Focus")] public Transform Target;
